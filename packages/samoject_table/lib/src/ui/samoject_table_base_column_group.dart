...
class SamojectTableBaseColumnGroup extends StatelessWidget
    implements SamojectTableVisibilityLayoutChild {
  final SamojectTableGridStateManager stateManager;

  final SamojectTableColumnGroupPair columnGroup;

  final int depth;

  SamojectTableBaseColumnGroup({
...
class _ExpandedColumn extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return SamojectTableBaseColumn(
      stateManager: stateManager,
      column: column,
...
class _ColumnGroup extends StatelessWidget {
  ...
  List<SamojectTableColumnGroupPair> get _separateLinkedGroup =>
      stateManager.separateLinkedGroup(
        columnGroupList: columnGroup.group.children!,
        columns: columnGroup.columns,
      );

  Widget _makeFieldWidget(SamojectTableColumn column) {
    return LayoutId(
      id: column.field,
  ...
  Widget _makeChildWidget(SamojectTableColumnGroupPair columnGroupPair) {
    return LayoutId(
...
class ColumnGroupLayout extends MultiChildLayoutDelegate {
  ...
  List<SamojectTableColumnGroupPair> separateLinkedGroups;
  ...
  void performLayout(Size size) {
    ...
    for (SamojectTableColumnGroupPair pair in separateLinkedGroups) {
