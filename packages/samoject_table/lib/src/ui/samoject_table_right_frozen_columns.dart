...
class SamojectTableRightFrozenColumns extends SamojectTableStatefulWidget {
  final SamojectTableGridStateManager stateManager;

  const SamojectTableRightFrozenColumns(
    this.stateManager, {
    super.key,
  });

  @override
  SamojectTableRightFrozenColumnsState createState() =>
      SamojectTableRightFrozenColumnsState();
}

class SamojectTableRightFrozenColumnsState
    extends SamojectTableStateWithChange<SamojectTableRightFrozenColumns> {
  ...
  Widget build(BuildContext context) {
    return CustomMultiChildLayout(
      delegate: MainColumnLayoutDelegate(
        ...
        frozen: SamojectTableColumnFrozen.end,
      ),
