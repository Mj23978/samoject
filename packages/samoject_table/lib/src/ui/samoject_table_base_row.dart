...
import '../manager/event/samoject_table_grid_drag_rows_event.dart';
...
class SamojectTableBaseRow extends StatelessWidget {
  final int rowIdx;
  ...
  bool _checkSameDragRows(SamojectTableRow draggingRow) {
    final List<SamojectTableRow> selectedRows =
  ...
  bool _handleOnWillAccept(SamojectTableRow? draggingRow) {
    if (draggingRow == null) {
      return false;
    }
  ...
  void _handleOnAccept(SamojectTableRow draggingRow) async {
  ...
  SamojectTableVisibilityLayoutId _buildCell(SamojectTableColumn column) {
    return SamojectTableVisibilityLayoutId(
      id: column.field,
      child: SamojectTableBaseCell(
  ...
  Widget build(BuildContext context) {
    return DragTarget<SamojectTableRow>(
...
class _RowContainerWidget extends SamojectTableStatefulWidget {
  final SamojectTableGridStateManager stateManager;
...
class _RowContainerWidgetState
    extends SamojectTableStateWithChange<_RowContainerWidget>
    with
        AutomaticKeepAliveClientMixin,
        SamojectTableStateWithKeepAlive<_RowContainerWidget> {
  @override
  ...
  BoxDecoration _getBoxDecoration() {
    ...
    return BoxDecoration(
      ...
      border: Border(
        top: isTopDragTarget
            ? BorderSide(
                width: SamojectTableGridSettings.rowBorderWidth,
