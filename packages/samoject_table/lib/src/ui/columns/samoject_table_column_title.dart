...
class SamojectTableColumnTitle extends SamojectTableStatefulWidget {
  ...
  @override
  SamojectTableColumnTitleState createState() =>
      SamojectTableColumnTitleState();
}

class SamojectTableColumnTitleState
    extends SamojectTableStateWithChange<SamojectTableColumnTitle> {
  late Offset _columnRightPosition;

  bool _isPointMoving = false;

  SamojectTableColumnSort _sort = SamojectTableColumnSort.none;
  ...
  @override
  void updateState() {
    _sort = update<SamojectTableColumnSort>(
      _sort,
      widget.column.sort,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final contextMenuIcon = Container(
      ...
      child: IconButton(
        icon: SamojectTableGridColumnIcon(
          sort: _sort,
...
class SamojectTableGridColumnIcon extends StatelessWidget {
  final SamojectTableColumnSort? sort;
  ...
  const SamojectTableGridColumnIcon({
    this.sort,
  ...
  Widget build(BuildContext context) {
    switch (sort) {
      case SamojectTableColumnSort.ascending:
        return ascendingIcon == null
            ...
            : ascendingIcon!;
      case SamojectTableColumnSort.descending:
...
class _BuildDraggableWidget extends StatelessWidget {
  ...
  void _handleOnPointerMove(PointerMoveEvent event) {
    stateManager.eventManager!.addEvent(SamojectTableGridScrollUpdateEvent(
      ...
      scrollDirection: SamojectTableGridScrollUpdateDirection.horizontal,
    ));
  }
  ...
  void _handleOnPointerUp(PointerUpEvent event) {
    SamojectTableGridScrollUpdateEvent.stopScroll(
      stateManager,
      SamojectTableGridScrollUpdateDirection.horizontal,
    );
  }
  ...
  Widget build(BuildContext context) {
    return Listener(
      ...
      child: Draggable<SamojectTableColumn>(
        data: column,
        ...
        feedback: FractionalTranslation(
          ...
          child: SamojectTableShadowContainer(
            ...
            width: SamojectTableGridSettings.minColumnWidth,
...
class _BuildColumnWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return DragTarget<SamojectTableColumn>(
      onWillAccept: (SamojectTableColumn? columnToDrag) {
      ...
      onAccept: (SamojectTableColumn columnToMove) {
...
class _CheckboxAllSelectionWidget extends SamojectTableStatefulWidget {
  final SamojectTableGridStateManager stateManager;
...
class _CheckboxAllSelectionWidgetState
    extends SamojectTableStateWithChange<_CheckboxAllSelectionWidget> {
  bool? _checked;
  ...
  void _handleOnChanged(bool? changed) {
    ...
    if (stateManager.onRowChecked != null) {
      stateManager.onRowChecked!(
        SamojectTableGridOnRowCheckedAllEvent(isChecked: changed),
      );
    }
...
class _ColumnTextWidget extends SamojectTableStatefulWidget {
  final SamojectTableGridStateManager stateManager;
...
class _ColumnTextWidgetState
    extends SamojectTableStateWithChange<_ColumnTextWidget> {
            ...
            child: IconButton(
              ...
              constraints: BoxConstraints(
                maxHeight: widget.height +
                    (SamojectTableGridSettings.rowBorderWidth * 2),
              ),
            ),
          ),
      ];
