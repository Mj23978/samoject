...
class SamojectTableColumnGroup {
  final String title;

  final List<String>? fields;

  final List<SamojectTableColumnGroup>? children;

  final EdgeInsets? titlePadding;

  /// Text alignment in Cell. (Left, Right, Center)
  final SamojectTableColumnTextAlign titleTextAlign;
  ...
  SamojectTableColumnGroup({
    ...
    this.titlePadding,
    this.titleSpan,
    this.titleTextAlign = SamojectTableColumnTextAlign.center,
  ...
  SamojectTableColumnGroup? parent;

  Iterable<SamojectTableColumnGroup> get parents sync* {
    var cursor = parent;
...
class SamojectTableColumnGroupPair {
  SamojectTableColumnGroup group;
  List<SamojectTableColumn> columns;

  SamojectTableColumnGroupPair({
    required this.group,
