...
class SamojectTablePagination extends SamojectTableStatefulWidget {
  const SamojectTablePagination(
    this.stateManager, {
    super.key,
  });
  ...
  @override
  SamojectTablePaginationState createState() => SamojectTablePaginationState();
}

abstract class _SamojectTablePaginationStateWithChange
    extends SamojectTableStateWithChange<SamojectTablePagination> {
  late int page;
...
class SamojectTablePaginationState
    extends _SamojectTablePaginationStateWithChange {
  late double _maxWidth;

  final _iconSplashRadius = SamojectTableGridSettings.rowHeight / 2;
