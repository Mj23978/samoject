...
mixin LayoutState implements ISamojectTableGridState {
  @override
  ...
  double get headerHeight {
    ...
    return _headerHeight == null
        ? SamojectTableGridSettings.rowTotalHeight
        : _headerHeight!;
  }
  ...
  @override
  double get rowTotalHeight =>
      rowHeight + SamojectTableGridSettings.rowBorderWidth;

  @override
  double get bodyTopOffset =>
      gridGlobalOffset!.dy +
      SamojectTableGridSettings.gridPadding +
      headerHeight +
  ...
  double get bodyLeftOffset {
    return (showFrozenColumn && leftFrozenColumnsWidth > 0)
        ? leftFrozenColumnsWidth + SamojectTableGridSettings.gridBorderWidth
        : 0;
  }
  ...
  double get bodyRightOffset {
    return (showFrozenColumn && rightFrozenColumnsWidth > 0)
        ? rightFrozenColumnsWidth + SamojectTableGridSettings.gridBorderWidth
        : 0;
  }
  ...
  double get bodyLeftScrollOffset {
    return gridGlobalOffset!.dx +
        SamojectTableGridSettings.gridPadding +
        SamojectTableGridSettings.gridBorderWidth +
        SamojectTableGridSettings.offsetScrollingFromEdge;
  }
  ...
  @override
  double get bodyUpScrollOffset {
    return bodyTopOffset + SamojectTableGridSettings.offsetScrollingFromEdge;
  }
  ...
  bool enoughFrozenColumnsWidth(double width) {
    return width >
        (leftFrozenColumnsWidth +
            rightFrozenColumnsWidth +
            SamojectTableGridSettings.bodyMinWidth +
            SamojectTableGridSettings.totalShadowLineWidth);
  }
