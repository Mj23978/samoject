...
class SamojectTableScrollbar extends StatefulWidget {
  const SamojectTableScrollbar({
    Key? key,
  ...
  @override
  SamojectTableGridCupertinoScrollbarState createState() =>
      SamojectTableGridCupertinoScrollbarState();
}

class SamojectTableGridCupertinoScrollbarState
    extends State<SamojectTableScrollbar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SamojectTableScrollbar oldWidget) {
