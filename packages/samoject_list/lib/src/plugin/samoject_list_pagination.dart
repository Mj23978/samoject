...
class SamojectListPagination extends SamojectListStatefulWidget {
  const SamojectListPagination(
    this.stateManager, {
    super.key,
  });
  ...
  @override
  SamojectListPaginationState createState() => SamojectListPaginationState();
}

abstract class _SamojectListPaginationStateWithChange
    extends SamojectListStateWithChange<SamojectListPagination> {
  late int page;
...
class SamojectListPaginationState
    extends _SamojectListPaginationStateWithChange {
  late double _maxWidth;

  final _iconSplashRadius = SamojectListGridSettings.rowHeight / 2;
