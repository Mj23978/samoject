...
class SamojectListScrollbar extends StatefulWidget {
  const SamojectListScrollbar({
    Key? key,
  ...
  @override
  SamojectListGridCupertinoScrollbarState createState() =>
      SamojectListGridCupertinoScrollbarState();
}

class SamojectListGridCupertinoScrollbarState
    extends State<SamojectListScrollbar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SamojectListScrollbar oldWidget) {
