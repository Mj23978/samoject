...
mixin LayoutState implements ISamojectListGridState {
  @override
  ...
  double get headerHeight {
    ...
    return _headerHeight == null
        ? SamojectListGridSettings.rowTotalHeight
        : _headerHeight!;
  }
  ...
  @override
  double get footerTopOffset =>
      maxHeight! - footerHeight - SamojectListGridSettings.totalShadowLineWidth;
  ...
  @override
  double get rowTotalHeight =>
      rowHeight + SamojectListGridSettings.rowBorderWidth;

  @override
  double get bodyTopOffset =>
      gridGlobalOffset!.dy +
      SamojectListGridSettings.gridPadding +
      headerHeight +
  ...
  double get bodyLeftOffset {
    return (showFrozenColumn && leftFrozenColumnsWidth > 0)
        ? leftFrozenColumnsWidth + SamojectListGridSettings.gridBorderWidth
        : 0;
  }
  ...
  double get bodyRightOffset {
    return (showFrozenColumn && rightFrozenColumnsWidth > 0)
        ? rightFrozenColumnsWidth + SamojectListGridSettings.gridBorderWidth
        : 0;
  }
  ...
  double get bodyLeftScrollOffset {
    return gridGlobalOffset!.dx +
        SamojectListGridSettings.gridPadding +
        SamojectListGridSettings.gridBorderWidth +
        SamojectListGridSettings.offsetScrollingFromEdge;
  }
  ...
  @override
  double get bodyUpScrollOffset {
    return bodyTopOffset + SamojectListGridSettings.offsetScrollingFromEdge;
  }
  ...
  double get scrollOffsetByFrozenColumn {
    ...
    if (_showFrozenColumn!) {
      offset += leftFrozenColumnsWidth > 0
          ? SamojectListGridSettings.gridBorderWidth
          : 0;
      offset += rightFrozenColumnsWidth > 0
          ? SamojectListGridSettings.gridBorderWidth
          : 0;
    }
  ...
  bool enoughFrozenColumnsWidth(double width) {
    return width >
        (leftFrozenColumnsWidth +
            rightFrozenColumnsWidth +
            SamojectListGridSettings.bodyMinWidth +
            SamojectListGridSettings.totalShadowLineWidth);
  }
