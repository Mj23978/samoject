...
class SamojectListColumnGroup {
  final String title;

  final List<String>? fields;

  final List<SamojectListColumnGroup>? children;

  final EdgeInsets? titlePadding;

  /// Text alignment in Cell. (Left, Right, Center)
  final SamojectListColumnTextAlign titleTextAlign;
  ...
  SamojectListColumnGroup({
    ...
    this.titlePadding,
    this.titleSpan,
    this.titleTextAlign = SamojectListColumnTextAlign.center,
  ...
  SamojectListColumnGroup? parent;

  Iterable<SamojectListColumnGroup> get parents sync* {
    var cursor = parent;
...
class SamojectListColumnGroupPair {
  SamojectListColumnGroup group;
  List<SamojectListColumn> columns;

  SamojectListColumnGroupPair({
    required this.group,
