...
abstract class SamojectListColumnType {
  dynamic get defaultValue;

  /// Set as a string column.
  factory SamojectListColumnType.text({
    dynamic defaultValue = '',
  }) {
    return SamojectListColumnTypeText(
  ...
  factory SamojectListColumnType.number({
    ...
    return SamojectListColumnTypeNumber(
      defaultValue: defaultValue,
      format: format,
      negative: negative,
  ...
  /// If not specified, the default locale is used.
  factory SamojectListColumnType.currency({
    dynamic defaultValue = 0,
    bool negative = true,
    String? format,
    bool applyFormatOnInit = true,
    ...
    return SamojectListColumnTypeCurrency(
      defaultValue: defaultValue,
      format: format,
      negative: negative,
      applyFormatOnInit: applyFormatOnInit,
  ...
  factory SamojectListColumnType.select(
    List<dynamic> items, {
    dynamic defaultValue = '',
    bool enableColumnFilter = false,
  }) {
    return SamojectListColumnTypeSelect(
      defaultValue: defaultValue,
      items: items,
  ...
  ///
  /// [applyFormatOnInit] When the editor loads, it resets the value to [format].
  factory SamojectListColumnType.date({
    dynamic defaultValue = '',
    DateTime? startDate,
    DateTime? endDate,
    ...
    return SamojectListColumnTypeDate(
      defaultValue: defaultValue,
      startDate: startDate,
      endDate: endDate,
      format: format,
  ...
  factory SamojectListColumnType.time({
    dynamic defaultValue = '00:00',
  }) {
    return SamojectListColumnTypeTime(
      defaultValue: defaultValue,
    );
  }
...
extension SamojectListColumnTypeExtension on SamojectListColumnType {
  bool get isText => this is SamojectListColumnTypeText;

  bool get isNumber => this is SamojectListColumnTypeNumber;

  bool get isCurrency => this is SamojectListColumnTypeCurrency;

  bool get isSelect => this is SamojectListColumnTypeSelect;

  bool get isDate => this is SamojectListColumnTypeDate;

  bool get isTime => this is SamojectListColumnTypeTime;

  SamojectListColumnTypeText get text {
    if (this is! SamojectListColumnTypeText) {
      throw TypeError();
    }

    return this as SamojectListColumnTypeText;
  }

  SamojectListColumnTypeNumber get number {
    if (this is! SamojectListColumnTypeNumber) {
      throw TypeError();
    }

    return this as SamojectListColumnTypeNumber;
  }

  SamojectListColumnTypeCurrency get currency {
    if (this is! SamojectListColumnTypeCurrency) {
      throw TypeError();
    }

    return this as SamojectListColumnTypeCurrency;
  }

  SamojectListColumnTypeSelect get select {
    if (this is! SamojectListColumnTypeSelect) {
      throw TypeError();
    }

    return this as SamojectListColumnTypeSelect;
  }

  SamojectListColumnTypeDate get date {
    if (this is! SamojectListColumnTypeDate) {
      throw TypeError();
    }

    return this as SamojectListColumnTypeDate;
  }

  SamojectListColumnTypeTime get time {
    if (this is! SamojectListColumnTypeTime) {
      throw TypeError();
    }

    return this as SamojectListColumnTypeTime;
  }

  bool get hasFormat => this is SamojectListColumnTypeHasFormat;

  bool get applyFormatOnInit => hasFormat
      ? (this as SamojectListColumnTypeHasFormat).applyFormatOnInit
      : false;

  dynamic applyFormat(dynamic value) => hasFormat
      ? (this as SamojectListColumnTypeHasFormat).applyFormat(value)
      : value;
}

class SamojectListColumnTypeText implements SamojectListColumnType {
  @override
  final dynamic defaultValue;

  const SamojectListColumnTypeText({
    this.defaultValue,
  });
...
class SamojectListColumnTypeNumber
    with SamojectListColumnTypeWithNumberFormat
    implements SamojectListColumnType, SamojectListColumnTypeHasFormat<String> {
  @override
  final dynamic defaultValue;
...
class SamojectListColumnTypeCurrency
    with SamojectListColumnTypeWithNumberFormat
    implements
        SamojectListColumnType,
        SamojectListColumnTypeHasFormat<String?> {
  @override
  final dynamic defaultValue;
  ...
  SamojectListColumnTypeCurrency({
    this.defaultValue,
    required this.negative,
    required this.format,
    required this.applyFormatOnInit,
...
class SamojectListColumnTypeSelect implements SamojectListColumnType {
  @override
  final dynamic defaultValue;
  ...
  const SamojectListColumnTypeSelect({
    this.defaultValue,
    required this.items,
...
class SamojectListColumnTypeDate
    implements
        SamojectListColumnType,
        SamojectListColumnTypeHasFormat<String>,
        SamojectListColumnTypeHasDateFormat {
  @override
  final dynamic defaultValue;
...
class SamojectListColumnTypeTime implements SamojectListColumnType {
  @override
  final dynamic defaultValue;

  const SamojectListColumnTypeTime({
    this.defaultValue,
  });
...
abstract class SamojectListColumnTypeHasFormat<T> {
  const SamojectListColumnTypeHasFormat({
    required this.format,
    required this.applyFormatOnInit,
  });
...
abstract class SamojectListColumnTypeHasDateFormat {
  const SamojectListColumnTypeHasDateFormat({
...
mixin SamojectListColumnTypeWithNumberFormat {
