...
class SamojectListRightFrozenColumns extends SamojectListStatefulWidget {
  final SamojectListGridStateManager stateManager;

  const SamojectListRightFrozenColumns(
    this.stateManager, {
    super.key,
  });

  @override
  SamojectListRightFrozenColumnsState createState() =>
      SamojectListRightFrozenColumnsState();
}

class SamojectListRightFrozenColumnsState
    extends SamojectListStateWithChange<SamojectListRightFrozenColumns> {
  ...
  Widget build(BuildContext context) {
    return CustomMultiChildLayout(
      delegate: MainColumnLayoutDelegate(
        ...
        frozen: SamojectListColumnFrozen.end,
      ),
