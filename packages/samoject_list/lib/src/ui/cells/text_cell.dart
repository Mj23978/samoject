...
import '../../helper/samoject_list_debounce.dart';
...
mixin TextCellState<T extends TextCell> on State<T> implements TextFieldProps {
  ...
  final SamojectListDebounceByHashCode _debounce =
      SamojectListDebounceByHashCode();
  ...
  bool _moveHorizontal(SamojectListKeyManagerEvent keyManager) {
