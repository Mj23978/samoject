...
class SamojectListBaseColumnGroup extends StatelessWidget
    implements SamojectListVisibilityLayoutChild {
  final SamojectListGridStateManager stateManager;

  final SamojectListColumnGroupPair columnGroup;

  final int depth;

  SamojectListBaseColumnGroup({
...
class _ColumnGroup extends StatelessWidget {
  ...
  List<SamojectListColumnGroupPair> get _separateLinkedGroup =>
      stateManager.separateLinkedGroup(
        columnGroupList: columnGroup.group.children!,
        columns: columnGroup.columns,
      );

  Widget _makeFieldWidget(SamojectListColumn column) {
    return LayoutId(
      id: column.field,
  ...
  Widget _makeChildWidget(SamojectListColumnGroupPair columnGroupPair) {
    return LayoutId(
...
class ColumnGroupLayout extends MultiChildLayoutDelegate {
  ...
  List<SamojectListColumnGroupPair> separateLinkedGroups;
  ...
  void performLayout(Size size) {
    ...
    for (SamojectListColumnGroupPair pair in separateLinkedGroups) {
