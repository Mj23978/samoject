...
class SamojectListColumnTitle extends SamojectListStatefulWidget {
  ...
  @override
  SamojectListColumnTitleState createState() => SamojectListColumnTitleState();
}

class SamojectListColumnTitleState
    extends SamojectListStateWithChange<SamojectListColumnTitle> {
  late Offset _columnRightPosition;

  bool _isPointMoving = false;

  SamojectListColumnSort _sort = SamojectListColumnSort.none;
  ...
  @override
  void updateState() {
    _sort = update<SamojectListColumnSort>(
      _sort,
      widget.column.sort,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final contextMenuIcon = Container(
      ...
      child: IconButton(
        icon: SamojectListGridColumnIcon(
          sort: _sort,
...
class SamojectListGridColumnIcon extends StatelessWidget {
  final SamojectListColumnSort? sort;
  ...
  const SamojectListGridColumnIcon({
    this.sort,
  ...
  Widget build(BuildContext context) {
    switch (sort) {
      case SamojectListColumnSort.ascending:
        return ascendingIcon == null
            ...
            : ascendingIcon!;
      case SamojectListColumnSort.descending:
...
class _BuildDraggableWidget extends StatelessWidget {
  ...
  void _handleOnPointerMove(PointerMoveEvent event) {
    stateManager.eventManager!.addEvent(SamojectListGridScrollUpdateEvent(
      ...
      scrollDirection: SamojectListGridScrollUpdateDirection.horizontal,
    ));
  }
  ...
  void _handleOnPointerUp(PointerUpEvent event) {
    SamojectListGridScrollUpdateEvent.stopScroll(
      stateManager,
      SamojectListGridScrollUpdateDirection.horizontal,
    );
  }
  ...
  Widget build(BuildContext context) {
    return Listener(
      ...
      child: Draggable<SamojectListColumn>(
        data: column,
        ...
        feedback: FractionalTranslation(
          ...
          child: SamojectListShadowContainer(
            ...
            width: SamojectListGridSettings.minColumnWidth,
...
class _BuildColumnWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return DragTarget<SamojectListColumn>(
      onWillAccept: (SamojectListColumn? columnToDrag) {
      ...
      onAccept: (SamojectListColumn columnToMove) {
...
class _CheckboxAllSelectionWidget extends SamojectListStatefulWidget {
  final SamojectListGridStateManager stateManager;
...
class _CheckboxAllSelectionWidgetState
    extends SamojectListStateWithChange<_CheckboxAllSelectionWidget> {
  bool? _checked;
  ...
  void _handleOnChanged(bool? changed) {
    ...
    if (stateManager.onRowChecked != null) {
      stateManager.onRowChecked!(
        SamojectListGridOnRowCheckedAllEvent(isChecked: changed),
      );
    }
...
class _ColumnTextWidget extends SamojectListStatefulWidget {
  final SamojectListGridStateManager stateManager;
...
class _ColumnTextWidgetState
    extends SamojectListStateWithChange<_ColumnTextWidget> {
            ...
            child: IconButton(
              ...
              constraints: BoxConstraints(
                maxHeight: widget.height +
                    (SamojectListGridSettings.rowBorderWidth * 2),
              ),
            ),
          ),
      ];
