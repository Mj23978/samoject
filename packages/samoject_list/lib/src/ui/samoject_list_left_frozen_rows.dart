...
class SamojectListLeftFrozenRows extends SamojectListStatefulWidget {
  final SamojectListGridStateManager stateManager;

  const SamojectListLeftFrozenRows(
    this.stateManager, {
    super.key,
  });

  @override
  SamojectListLeftFrozenRowsState createState() =>
      SamojectListLeftFrozenRowsState();
}

class SamojectListLeftFrozenRowsState
    extends SamojectListStateWithChange<SamojectListLeftFrozenRows> {
