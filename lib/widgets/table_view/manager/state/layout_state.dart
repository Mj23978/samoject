...
mixin LayoutState implements ITableGridState {
  @override
  ...
  double get headerHeight {
    ...
    return _headerHeight == null
        ? TableGridSettings.rowTotalHeight
        : _headerHeight!;
  }
  ...
  @override
  double get footerTopOffset =>
      maxHeight! - footerHeight - TableGridSettings.totalShadowLineWidth;
  ...
  @override
  double get columnBottomOffset =>
      maxHeight! - rowsTopOffset - TableGridSettings.totalShadowLineWidth;
  ...
  @override
  double get rowTotalHeight => rowHeight + TableGridSettings.rowBorderWidth;

  @override
  double get bodyTopOffset =>
      gridGlobalOffset!.dy +
      TableGridSettings.gridPadding +
      headerHeight +
  ...
  double get bodyLeftOffset {
    return (showFrozenColumn && leftFrozenColumnsWidth > 0)
        ? leftFrozenColumnsWidth + TableGridSettings.gridBorderWidth
        : 0;
  }
  ...
  double get bodyRightOffset {
    return (showFrozenColumn && rightFrozenColumnsWidth > 0)
        ? rightFrozenColumnsWidth + TableGridSettings.gridBorderWidth
        : 0;
  }
  ...
  double get bodyLeftScrollOffset {
    return gridGlobalOffset!.dx +
        TableGridSettings.gridPadding +
        TableGridSettings.gridBorderWidth +
        TableGridSettings.offsetScrollingFromEdge;
  }
  ...
  @override
  double get bodyUpScrollOffset {
    return bodyTopOffset + TableGridSettings.offsetScrollingFromEdge;
  }
  ...
  double get scrollOffsetByFrozenColumn {
    ...
    if (_showFrozenColumn!) {
      offset +=
          leftFrozenColumnsWidth > 0 ? TableGridSettings.gridBorderWidth : 0;
      offset +=
          rightFrozenColumnsWidth > 0 ? TableGridSettings.gridBorderWidth : 0;
    }
  ...
  bool enoughFrozenColumnsWidth(double width) {
    return width >
        (leftFrozenColumnsWidth +
            rightFrozenColumnsWidth +
            TableGridSettings.bodyMinWidth +
            TableGridSettings.totalShadowLineWidth);
  }
