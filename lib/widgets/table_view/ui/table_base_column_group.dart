...
class TableBaseColumnGroup extends StatelessWidget
    implements TableVisibilityLayoutChild {
  final TableGridStateManager stateManager;

  final TableColumnGroupPair columnGroup;

  final int depth;

  TableBaseColumnGroup({
...
class _ColumnGroup extends StatelessWidget {
  ...
  Widget _makeChildWidget(TableColumnGroupPair columnGroupPair) {
    return LayoutId(
...
class ColumnGroupLayout extends MultiChildLayoutDelegate {
  ...
  List<TableColumnGroupPair> separateLinkedGroups;
  ...
  void performLayout(Size size) {
    ...
    for (TableColumnGroupPair pair in separateLinkedGroups) {
