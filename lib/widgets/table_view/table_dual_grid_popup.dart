...
/// [TableDualGridPopup] can connect the keyboard movement between the two grids
/// by arranging two [TableGrid] left and right.
/// It works as a popup.
class TableDualGridPopup {
  ...
  Future<void> open() async {
    ...
    TableDualOnSelectedEvent? selected =
        await showDialog<TableDualOnSelectedEvent>(
            context: context,
                    ...
                    return SizedBox(
                      ...
                      child: Directionality(
                        ...
                        child: TableDualGrid(
                          ...
                          display: display ?? TableDualGridDisplayRatio(),
                          divider: divider ?? const TableDualGridDivider(),
                        ),
                      ),
                    );
                  },
  ...
  TableDualGridProps _applyBorderRadiusToGridProps(
    BorderRadius? borderRadius,
    TableDualGridProps gridProps,
  ) {
    if (borderRadius == null) {
      return gridProps;
    }
