...
class TablePagination extends TableStatefulWidget {
  ...
  @override
  TablePaginationState createState() => TablePaginationState();
}

abstract class _TablePaginationStateWithChange
    extends TableStateWithChange<TablePagination> {
  late int page;
...
class TablePaginationState extends _TablePaginationStateWithChange {
  late double _maxWidth;

  final _iconSplashRadius = TableGridSettings.rowHeight / 2;
